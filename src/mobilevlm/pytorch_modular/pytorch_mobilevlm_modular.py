...
torch_kv = pytorch_zero_kv(seq_len=1)   # [24, 2, 1, 16, 1, 128]
...
with torch.no_grad():
        outputs = mobilellama(              # MobileLlamaModel
            ...
            attention_mask=attention_mask,  # [1,195]
            past_key_values=torch_kv,       # [24,2,1,16,1,128]
            use_cache=True,
...
for step in range(max_new_tokens):
    ...
    max_attention_mask[:, :cur_len] = 1
    max_attention_mask[:, -1:] = 1

    max_torch_kv = pytorch_zero_kv(seq_len=235)   # [24, 2, 1, 16, 235, 128]

...
class MobileLlamaDecoderWrapper(nn.Module):
...
wrapper = MobileLlamaDecoderWrapper(
    mobilellama
).eval()
...
if USE_INT8_COMPRESSION:
    ...
    SAVE_PATH = "mobilellama_decoder_int8.mlpackage"

else:
    final_model = mlmodel
    SAVE_PATH = "mobilellama_decoder_fp16.mlpackage"
